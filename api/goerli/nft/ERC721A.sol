...
IERC721Enumerable
{
    ...
    //  In order to ensure that your address of NFT don't run ahead of time11
    mapping(uint256 => uint) public timeByTokenId;
   ...
   */
    function _safeMint(
        ...
        for (uint256 i = 0; i < quantity; i++) {
            ...
            timeByTokenId[updatedIndex]=block.timestamp;
            updatedIndex++;
        }
